...
**Recommendation:** Use Firefox browser or [this website](https://github.com/AsuraClient/fca-unofficial) to reduce logout issues, especially for iOS users.

**Support:** If you encounter errors, contact us [here](https://www.facebook.com/Anh1314029)
...
`AsuraClient/fca-unofficial` is the only API that allows you to automate chat functionalities on a **user account** by emulating the browser. This means:
...
// Configuration can be loaded from file or environment variables
const options = {
  listenEvents: true,
  selfListen: false,
  logLevel: "info"
    ...
    api.listenMqtt((err, event) => {
      ...
      switch (event.type) {
        case "message":
          ...
          break;
        case "event":
          console.log(`Event: ${event.logMessageBody}`);
          break;
      }
    });
  }
...
[See more projects...](https://github.com/AsuraClient/fca-unofficial#projects-using-this-api)
...
**ASURA2123** - [Facebook](https://www.facebook.com/Anh1314029)
...
- [NPM Package](https://www.npmjs.com/package/AsuraClient/fca-unofficial)
- [GitHub Repository](https://github.com/AsuraClient/fca-unofficial)
- [Issue Tracker](https://github.com/AsuraClient/fca-unofficial/issues)
